...
export function TeamMemberTable({ members, users, roles, teams, onRefresh }: Props) {
        ...
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">สมาชิกใน Teams</p>
                </div>
                {canWrite && (
            ...
            <TeamMemberDialog open={dialogOpen} onOpenChange={setDialogOpen} member={selected} users={users} roles={roles} teams={teams} onSuccess={onRefresh} />
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            นำ &quot;{selected?.user.name ?? selected?.user.email}&quot; ออกจาก Team &quot;{selected?.team.name}&quot;?
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
